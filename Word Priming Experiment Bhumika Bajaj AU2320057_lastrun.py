...
expName = 'Word Priming Experiment Bhumika Bajaj AU2320057'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\bhumika\\PSYLAB310\\Word Priming Bhumika Bajaj AU2320057\\Word Priming Experiment Bhumika Bajaj AU2320057_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisTrial_2 in trials_2:
        ...
        test = data.Routine(
            name='test',
            components=[text_2, textbox, text_3, testmouse],
        )
