...
expName = 'Intentional Binding PSY310 Bhumika Bajaj AU2320057'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\bhumika\\Intentional Binding PSY310 Bhumika Bajaj AU2320057_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('OneDrive/Documents/intentional binding psy310.xlsx'), 
        seed=None, 
    )
