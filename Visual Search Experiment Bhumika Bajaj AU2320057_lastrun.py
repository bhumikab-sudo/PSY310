...
expName = 'Visual Search Experiment Bhumika Bajaj AU2320057'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\bhumika\\PSYLAB310\\Visual Search Bhumika Bajaj AU2320057\\Visual Search Experiment Bhumika Bajaj AU2320057_lastrun.py',
    ...
    for thisTrial in trials:
        ...
        for i in range(num_distr):
            distr = visual.TextStim(win=win, name='distr',
                text='L',
                font='Arial',
                pos=(random()-0.5, random()-0.5), draggable=False, height=0.05, wrapWidth=None, ori=randint(1,360),
                color='white', colorSpace='rgb', opacity=None,
                languageStyle='LTR',
                depth=-2.0)
