...
expName = 'Motor Sequence Learning Bhumika Bajaj AU2320057'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\bhumika\\PSYLAB310\\Motor Sequence Learning Bhumika Bajaj AU2320057\\Motor Sequence Learning Bhumika Bajaj AU2320057_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('C:/Users/bhumika/OneDrive/Documents/sequence_con.csv.xlsx'), 
        seed=None, 
    )
